            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  <form action="" method="post" onsubmit="return confirm('Khi xóa danh mục `<?php echo $category['category_name']; ?>` các danh mục con và thú cưng bên trong của nó cũng sẽ bị xóa. Bạn có chắn chắc muốn xóa ?')">
