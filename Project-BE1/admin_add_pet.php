...
if (isset($_POST['pet-name']) && isset($_POST['pet-price']) && isset($_POST['pet-description']) && isset($_POST['category-id'])) {
  ...
  if ($petModel->addPet($petName, $petPrice, $petPhoto, $petDescription, $categoryID)) {
    $_SESSION['addPetAlert'] = '<div class="form-alert-success">Thêm thành công ! <span class="close-btn" onclick="this.parentElement.style.display=' . "'none'" . ';">&times;</span></div>';
  }
}
...
<head>
  <title>Thêm thú cưng - P3 Pet Shop</title>
  <meta charset="UTF-8">
  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        <form action="admin_add_pet.php" method="POST" enctype="multipart/form-data" class="login100-form validate-form">
          <a class="logo" href="."><img class="logo-img" src="./public/img/logo/P3.png" alt="P3 Logo"></a>

          <span class="login100-form-title p-b-26">Thêm thú cưng</span>
          ...
          <div class="wrap-input100 validate-input" data-validate="Chưa nhập tên thú cưng">
            <input class="input100" type="text" id="pet-name" name="pet-name">
          ...
          <div class="wrap-input100 validate-input" data-validate="Chưa nhập giá thú cưng">
            <input class="input100" type="text" id="pet-price" name="pet-price">
            <span class="focus-input100" data-placeholder="Giá thú cưng"></span>
          </div>

          <div class="wrap-input100" data-validate="Chưa nhập mô tả">
            <input class="input100" type="text" id="pet-description" name="pet-description">
