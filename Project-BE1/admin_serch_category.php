...
if (!empty($_GET['key'])) {
  ...
  $totalPage = ceil($categoryModel->getTotalCategoriesWithKey($key) / $perPage);
  /* Pagination - End */

  $categoriesList = $categoryModel->getCategoriesByKeywordAndPage($key, $page, $perPage);
} else {
...
<head>
  ...
  <title>Tìm kiếm '<?php if (isset($key)) {
                      echo $key;
                    } ?>' - P3 Pet Shop</title>
      ...
      <div class="table-wrap">
        <div class="table-bar mb-4">
          ...
          <section class="d-flex align-items-center">
            ...
            <form method="post" action="admin_serch_category.php?key=<?php if (isset($key)) {
                                                                        echo $key;
                                                                      } ?>" class="form-per-page d-inline-block ms-2">
            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  <form action="admin-delete-category.php" method="post" onsubmit="return confirm('Khi xóa danh mục `<?php echo $category['category_name']; ?>` các danh mục con của nó cũng sẽ bị xóa. Bạn có chắn chắc muốn xóa ?')">
        ...
        <nav aria-label="Page navigation" class="mt-4">
          <ul class="pagination justify-content-center">
            ...
            ?>
              <li class="page-item">
                <a class="page-link" href="admin_serch_category.php?key=<?php if (isset($key)) {
                                                                          echo $key;
              ...
              <li class="page-item">
                <a class="page-link" href="admin_serch_category.php?key=<?php if (isset($key)) {
                                                                          echo $key;
                                                                        } ?>&page=<?php echo $page - 1; ?>"><i class="fa-regular fa-circle-left"></i></a>
              </li>
            <?php
            }
            ?>
            ...
            for ($pageItem = 1; $pageItem <= $totalPage; $pageItem++) {
              if ($pageItem == $page) {
            ?>
                <li class="page-item active"><a class="page-link" href="admin_serch_category.php?key=<?php if (isset($key)) {
                                                                                                        echo $key;
                                                                                                      } ?>&page=<?php echo $pageItem; ?>"><?php echo $pageItem; ?></a></li>
              <?php
              } else {
              ?>
            ...
            ?>
              <li class="page-item">
                <a class="page-link" href="admin_serch_category.php?key=<?php if (isset($key)) {
                                                                          echo $key;
                                                                        } ?>&page=<?php echo $page + 1; ?>"><i class="fa-regular fa-circle-right"></i></a>
              </li>
              <li class="page-item">
                <a class="page-link" href="admin_serch_category.php?key=<?php if (isset($key)) {
                                                                          echo $key;
                                                                        } ?>&page=<?php echo $totalPage; ?>"><i class="fa-solid fa-circle-right"></i></a>
              </li>
            <?php
            }
            ?>
