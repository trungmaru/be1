...
$_SESSION['addCategoryAlert'] = '';

if (isset($_POST['category-name']) && isset($_POST['parent-id'])) {
  $categoryName = $_POST['category-name'];
  $parentID = $_POST['parent-id'];
  if ($categoryModel->addCategory($categoryName, $parentID)) {
    $_SESSION['addCategoryAlert'] = '<div class="form-alert-success">Thêm thành công ! <span class="close-btn" onclick="this.parentElement.style.display=' . "'none'" . ';">&times;</span></div>';
  }
}
...
<head>
  <title>Thêm danh mục - P3 Pet Shop</title>
  <meta charset="UTF-8">
  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        <form action="admin_add_category.php" method="POST" class="login100-form validate-form">
          <a class="logo" href="."><img class="logo-img" src="./public/img/logo/P3.png" alt="P3 Logo"></a>

          <span class="login100-form-title p-b-26">Thêm danh mục</span>

          <div class="wrap-input100 validate-input" data-validate="Chưa nhập tên danh mục">
            <input class="input100" type="text" id="category-name" name="category-name">
          ...
          if (isset($_SESSION['addCategoryAlert'])) {
            echo $_SESSION['addCategoryAlert'];
          }
          ?>
