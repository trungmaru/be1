...
$totalPage = ceil($petModel->getTotalPets() / $perPage);
/* Pagination - End */

$petList = $petModel->getPetsByPage($page, $perPage);
?>
...
<head>
  ...
  <title>Quản lý thú cưng - P3 Pet Shop</title>
...
<body>
  ...
  <section class="admin-sidebar">
    ...
    <ul class="admin-side-bar-list">
      ...
      <li class="admin-side-bar-item"><a class="admin-side-bar-link active" href="admin_manage_pet.php"><i class="fa-solid fa-shield-cat"></i> Quản lý thú cưng</a></li>
    ...
    <main>
      <div class="table-wrap">
        <div class="table-bar mb-4">
          <a class="btn btn-primary" href="admin_add_pet.php"><i class="fa-solid fa-file-circle-plus"></i> Thêm thú cưng</a>
          <section class="d-flex align-items-center">
            <span class="d-inline">Số hàng: </span>
            <form method="post" action="admin_manage_pet.php" class="form-per-page d-inline-block ms-2">
        ...
        <table class="table table-hover table-dark">
          <thead>
            <tr>
              ...
              <th><i class="fa-solid fa-dollar-sign"></i> Giá</th>
              <th><i class="fa-solid fa-eye"></i> Lượt xem</th>
              <th><i class="fa-solid fa-heart"></i> Lượt thích</th>
              <th><i class="fa-solid fa-list"></i> Danh mục</th>
              <th><i class="fa-solid fa-calendar-days"></i> Sửa lần cuối</th>
          ...
          <tbody>
            ...
            foreach ($petList as $pet) {
              ...
              $petCategory = $categoryModel->getCategoryByID($pet['category_id'])['category_name'];
            ?>
              <tr>
                <td><img class="table-content-pet img-fluid rounded-4" src="public/img/pets_photo/<?php echo $petPhoto; ?>" alt="Hình ảnh của một con vật nào đó"></td>
                <td><span class="table-content-pet"><?php echo $pet['pet_name']; ?></span></td>
                <td><span class="table-content-pet"><?php echo $model->currencyFormat($pet['pet_price']); ?></span></td>
                <td><span class="table-content-pet"><?php echo $pet['pet_view']; ?></span></td>
                <td><span class="table-content-pet"><?php echo $pet['pet_like']; ?></span></td>
                <td><span class="table-content-pet"><?php echo $petCategory; ?></span></td>
                <td><span class="table-content-pet"><?php echo $pet['time_create']; ?></span></td>
                <td>
                  <a class="btn btn-warning mb-2 mt-2" href="admin_edit_pet.php?id=<?php echo $pet['id']; ?>"><i class="fa-solid fa-pencil"></i> Sửa thông tin</a>
                  <form action="admin_delete_pet.php" method="post" onsubmit="return confirm('Bạn có chắc chắn muốn xóa thú cưng `<?php echo $pet['pet_name']; ?>` ?')">
                    <input type="hidden" name="deleteId" value="<?php echo $pet['id'] ?>">
                    <button class="btn btn btn-danger mb-2 mt-2" type="submit"><i class="fa-solid fa-trash"></i> Xóa thú cưng</button>
                  </form>
                </td>
              </tr>
            <?php
        ...
        <nav aria-label="Page navigation" class="mt-4">
          <ul class="pagination justify-content-center">
            ...
            ?>
              <li class="page-item">
                <a class="page-link" href="admin_manage_pet.php"><i class="fa-solid fa-circle-left"></i></a>
              </li>
              <li class="page-item">
                <a class="page-link" href="admin_manage_pet.php?page=<?php echo $page - 1; ?>"><i class="fa-regular fa-circle-left"></i></a>
              </li>
            <?php
            }
            ?>
            ...
            for ($pageItem = 1; $pageItem <= $totalPage; $pageItem++) {
              if ($pageItem == $page) {
            ?>
                <li class="page-item active"><a class="page-link" href="admin_manage_pet.php?page=<?php echo $pageItem; ?>"><?php echo $pageItem; ?></a></li>
              <?php
              } else {
              ?>
                <li class="page-item" <?php if ($pageItem > $getAdd || $pageItem < $getMinus) {
                                        echo "style='display:none;position:absolute'";
                                      } ?>><a class="page-link" href="admin_manage_pet.php?page=<?php echo $pageItem; ?>"><?php echo $pageItem; ?></a></li>
            <?php
              }
            }
            ?>
            ...
            ?>
              <li class="page-item">
                <a class="page-link" href="admin_manage_pet.php?page=<?php echo $page + 1; ?>"><i class="fa-regular fa-circle-right"></i></a>
              </li>
              <li class="page-item">
                <a class="page-link" href="admin_manage_pet.php?page=<?php echo $totalPage; ?>"><i class="fa-solid fa-circle-right"></i></a>
              </li>
            <?php
            }
            ?>
