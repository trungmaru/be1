...
if (isset($_GET['id'])) {
  $rootCategoryName = $_GET['name'];
  $rootCategoryID = $_GET['id'];
  $subCategoriesList2 = $categoryModel->getAllCategoriesByParentID($rootCategoryID);
  foreach ($subCategoriesList2 as $subCategory2) {
    $petListBySubCategory2 = $petModel->getPetsByCategoryID($subCategory2['id']);
    $petList = array_merge($petList, $petListBySubCategory2);
  }

  $title = $categoryModel->getCategoryByID($rootCategoryID)['category_name'];
}
                ...
                <div class="pet-card">
                  ...
                  <div class="pet-card-body">
                    ...
                    <div class="pet-interactive">
                      ...
                      <form action="category_pet.php?name=<?php echo $rootCategoryName; ?>&id=<?php echo $rootCategoryID; ?>" method="POST" class="d-inline">
                        <?php
                        if (isset($_SESSION['id'])) {
