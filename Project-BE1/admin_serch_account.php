...
if (!empty($_GET['key'])) {
  ...
  $totalPage = ceil($userModel->getTotalUsersWithKey($key) / $perPage);
  /* Pagination - End */

  $userList = $userModel->getUsersByKeywordAndPage($key, $page, $perPage);
} else {
      ...
      <div class="table-wrap">
        <div class="table-bar mb-4">
          ...
          <section class="d-flex align-items-center">
            ...
            <form method="post" action="admin_serch_account.php?key=<?php if (isset($key)) {
                                                                      echo $key;
        ...
        <nav aria-label="Page navigation" class="mt-4">
          <ul class="pagination justify-content-center">
            ...
            ?>
              <li class="page-item">
                <a class="page-link" href="admin_serch_account.php?key=<?php if (isset($key)) {
                                                                          echo $key;
            ...
            for ($pageItem = 1; $pageItem <= $totalPage; $pageItem++) {
              if ($pageItem == $page) {
            ?>
                <li class="page-item active"><a class="page-link" href="admin_serch_account.php?key=<?php if (isset($key)) {
                                                                                                      echo $key;
